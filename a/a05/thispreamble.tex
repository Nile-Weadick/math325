...
\topmatter
\score \\ \\
Open \texttt{main.tex} and for each question you'll see
\texttt{input} followed by a filename such as \texttt{02-05-18.tex}.
(which contains your work on chapter 2, section 5, question 18
from our textbook).
Enter your answer in the file \texttt{02-05-18.tex}.
